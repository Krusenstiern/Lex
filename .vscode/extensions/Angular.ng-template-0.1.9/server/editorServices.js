...
var Project = /** @class */ (function () {
    function Project(projectService, logger, projectOptions, languageServiceDisabled) {
        if (languageServiceDisabled === void 0) { languageServiceDisabled = false; }
...
function logServiceTimes(logger, service) {
    ...
    return {
        ...
        getTemplateReferences: function () {
            return time("getTemplateReferences", function () { return service.getTemplateReferences(); });
        },
