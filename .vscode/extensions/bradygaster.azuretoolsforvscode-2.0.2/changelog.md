## 2.0.1
- Remove all telemetry-collection, as the product is being sunset and will no longer be monitored or receive feature updates. 

## 2.0.0
- Deprecating features in lieu of the official extensions.
- Takes a dependency on the official extensions to replace this one's functionality. 
